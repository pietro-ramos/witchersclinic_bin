...
void menuBruxo()
{
    ...
    while (opcao != 0)
    {
        ...
        case 2:
            // Cadastrar bruxo
            novoBruxo.codigo = get_int_input("Digite o código do Bruxo: ");
            strcpy(novoBruxo.nome, get_string_input("Digite o nome do Bruxo: "));
			strcpy(novoBruxo.especialidade, get_string_input("Digite a especialidade do Bruxo: "));
        ...
        case 3:
            // Alterar bruxo
            {
	    		...
	    		char novaEspecialidade[MAX_STRING];
				strcpy(novoNome, get_string_input("Digite o novo nome do Bruxo: "));
				strcpy(novaEspecialidade, get_string_input("Digite a nova especialidade do Bruxo: "));
...
void menuPaciente()
{
    ...
    while (opcao != 0)
    {
        ...
        {
            novoPaciente.codigo = get_int_input("Digite o código do Paciente: ");
            strcpy(novoPaciente.nome, get_string_input("Digite o nome do Paciente: "));
            novoPaciente.idade = get_int_input("Digite a idade do Paciente: ");
            novoPaciente.altura = get_float_input("Digite a altura do Paciente(em x,xx): ");

            resultadoCadastro = SalvarPaciente(novoPaciente);
            if (resultadoCadastro == 0)
            {
                printf("Código já existente. Por favor, insira um código diferente.\n");
            }
        ...
        case 3: // Alterar paciente
        {
            ...
            strcpy(novoNome, get_string_input("Digite o novo nome do Paciente: "));
    ...
    while (opcao != 0)
    {
        ...
        switch (opcao)
        {
            ...
            case 2: // Cadastrar poção
                {
                    int codigo = get_int_input("Digite o código da Poção: ");
                    char nome[MAX_STRING];
                    strcpy(nome, get_string_input("Digite o nome da Poção: "));
                    char tipo[MAX_STRING];
                    strcpy(tipo, get_string_input("Digite o tipo da Poção: "));
                    
                    Pocao novaPocao;
                    novaPocao.codigo = codigo;
                    strcpy(novaPocao.nome, nome);
                    strcpy(novaPocao.tipo, tipo);

                    int resultadoCadastro = SalvarPocao(novaPocao);
            ...
            case 3: // Alterar poção
                {
                    int codigo = get_int_input("Digite o código da Poção que deseja atualizar: ");
                    char novoNome[MAX_STRING];
                    strcpy(novoNome, get_string_input("Digite o novo nome da Poção: "));
                    char novoTipo[MAX_STRING];
                    strcpy(novoTipo, get_string_input("Digite o novo tipo da Poção: "));
            ...
            case 4: // Excluir poção
                {
                    int codigo = get_int_input("Digite o código da Poção que deseja apagar: ");
...
void menuTratamento()
{
    ...
    while (opcao != 0)
    {
        ...
        case 1:
            {
                int codigo = get_int_input("Digite o código do Paciente para listar os tratamentos: ");
                ...
                if (totalTratamentosPaciente > 0)
                {
                    ...
                    {
                        Tratamento* tratamento = ObterTratamentoPeloCodigo(tratamentosPaciente[i]);
                        if (tratamento != NULL)
                        {
        ...
        case 2:
            {
                int codigo = get_int_input("Digite o código do Bruxo para listar os tratamentos: ");
                ...
                if (totalTratamentosBruxo > 0)
                {
                    ...
                    {
                        Tratamento* tratamento = ObterTratamentoPeloCodigo(tratamentosBruxo[i]);
                        if (tratamento != NULL)
                        {
                            printf("Codigo do Tratamento: %d\n", tratamento->codigoTratamento);
                            printf("Codigo do Paciente: %d\n", tratamento->codigoPaciente);
        ...
        case 4:
            {
                int codigo = get_int_input("Digite o codigo do Tratamento para ampliar: ");
        ...
        case 5:
            {
                int codigo = get_int_input("Digite o codigo do Tratamento para apagar: ");
